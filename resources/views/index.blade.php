...
<section class="w-full md:w-2/3 xl:w-1/2 mx-auto px-2 sm:px-4">
    ...
    <div class="font-display text-sm md:text-lg md:leading-loose">
        ...
        <p>&nbsp;<span class="text-dark">9</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-yellow">'<a rel="noopener noreferer" class="underline" target="_blank" href="https://tailwindcss.com">Tailwind CSS</a>'</span>, <span class="text-dark">// <em>My favorite!</em></span></p>
